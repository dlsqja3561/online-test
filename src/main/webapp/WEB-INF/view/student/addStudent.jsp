                                ...
                                <div class="card-body text-center">
									...
									<form method="post" action="${pageContext.request.contextPath}/employee/student/addStudent">
										<table class="table table-bordered col-md-20">
											<tr>
												<td>studentId</td>
												<td><input type="text" id="studentId" name="studentId" readonly="readonly" class="form-control bg-light border-0 small" placeholder="ID check"></td>
											</tr>
											<tr>
												<td>studentPw</td>
												<td><input type="password" id="studentPw" name="studentPw" class="form-control bg-light border-0 small"></td>
											</tr>
											<tr>
												<td>studentName</td>
												<td><input type="text" id="studentName" name="studentName" class="form-control bg-light border-0 small"></td>
											</tr>   
										</table>
										<button type="submit" class="btn btn-primary">학생추가</button>
									</form>
                                </div>
                            </div>
                        </div>
